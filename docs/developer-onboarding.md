...
> **Related docs:** [Auto Mode Pipeline](./auto-mode-flowchart.md) · [Firestore Debug Rules](./firestore-debug-rules.md) · [Architecture](./ARCHITECTURE.md) · [DB Schema](./DB_SCHEMA.md) · [Code Style](./CODE_STYLE.md)
