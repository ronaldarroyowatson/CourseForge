...
- Cloud provider fallback chain operational (OpenAI â†’ GitHub Models â†’ local Tesseract)
...
- Firebase Functions OCR/AI callables now consume `OPENAI_API_KEY` through v2 secrets configuration, preventing false â€œcloud unavailableâ€ states caused by missing secret injection.
