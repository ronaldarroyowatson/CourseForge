...
- Cloud provider fallback chain operational (OpenAI Ã¢â€ â€™ GitHub Models Ã¢â€ â€™ local Tesseract)
...
- Firebase Functions OCR/AI callables now consume `OPENAI_API_KEY` through v2 secrets configuration, preventing false Ã¢â‚¬Å“cloud unavailableÃ¢â‚¬Â states caused by missing secret injection.
