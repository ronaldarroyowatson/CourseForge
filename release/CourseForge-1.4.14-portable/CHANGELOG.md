...
- Cloud provider fallback chain operational (OpenAI ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ GitHub Models ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ local Tesseract)
...
- Firebase Functions OCR/AI callables now consume `OPENAI_API_KEY` through v2 secrets configuration, preventing false ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œcloud unavailableÃƒÂ¢Ã¢â€šÂ¬Ã‚Â states caused by missing secret injection.
